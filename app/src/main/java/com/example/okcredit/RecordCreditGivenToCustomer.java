...
public class RecordCreditGivenToCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_credit_given_to_customer);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecordCreditGivenToCustomer.this, LearnHowToUseOkCredit.class);
